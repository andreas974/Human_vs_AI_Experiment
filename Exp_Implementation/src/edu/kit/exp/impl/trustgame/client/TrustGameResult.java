...
/**
 * Screen shown to subjects at the end of a period
 */
public class TrustGameResult extends Screen {

	private static final long serialVersionUID = -7458682293164994953L;

	private String message;
	private JLabel jlabel;

	public TrustGameResult(String gameId, TrustGameParamObject parameter, String screenId, Long showUpTime) {
