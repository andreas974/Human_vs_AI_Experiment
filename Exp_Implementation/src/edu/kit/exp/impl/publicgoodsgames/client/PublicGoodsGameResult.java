 ...
 */
public class PublicGoodsGameResult extends Screen {

	private static final long serialVersionUID = 6551567784790963165L;

	private String message;
	private JLabel jlabel;

	public PublicGoodsGameResult(String gameId, PublicGoodsGameParamObject parameter, String screenId,
			Long showUpTime) {
