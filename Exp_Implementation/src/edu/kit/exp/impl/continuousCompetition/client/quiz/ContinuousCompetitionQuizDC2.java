 ...
 */
public class ContinuousCompetitionQuizDC2 extends QuizScreen {
    public ContinuousCompetitionQuizDC2(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
