 ...
 */
public class ContinuousCompetitionQuizRC3_agent extends QuizScreen {

    public ContinuousCompetitionQuizRC3_agent(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
