 ...
 */
public class ContinuousCompetitionQuizRB3_agent extends QuizScreen {

    public ContinuousCompetitionQuizRB3_agent(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
