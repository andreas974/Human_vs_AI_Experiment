 ...
 */
public class ContinuousCompetitionQuizDB2 extends QuizScreen {

    public ContinuousCompetitionQuizDB2(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
