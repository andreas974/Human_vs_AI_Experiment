 ...
 */
public class ContinuousCompetitionQuizRC2 extends QuizScreen {

    public ContinuousCompetitionQuizRC2(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
