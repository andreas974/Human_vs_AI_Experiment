...
/**
 * The class QuizItem represents all quiz items that can be displayed to a
 * client. All new quiz items have to implement this class.
 */
public abstract class QuizItem implements QuestionItem {
